...
def menu_usuarios(repo: UsuarioRepo):
    while True:
        ...
        if op == "1":
            ...
            try:
                repo.actualizar(Usuario(uid, nombre, correo, rol))
                print("Actualizado.")
            except Exception as e:
...
def seed_data(usuario_repo, cliente_repo, producto_repo):
    if not usuario_repo.listar():
        usuarios = [
            Usuario(None, "Yiced", "Yiced@gmail.com", "administrador"),
            Usuario(None, "Julian", "Julian@gmail.com", "administrador"),
            Usuario(None, "Carlos", "Carlos@gmail.com", "administrador"),
            Usuario(None, "Gerente1", "empleado1@gmail.com", "gerente"),
            Usuario(None, "Cajero1", "cajero1@gmail.com", "cajero")
        ]
        for u in usuarios:
